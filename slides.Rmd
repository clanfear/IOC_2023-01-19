...
* Strong **internal validity** from experimental design---rules out confounding

* Weak **external validity**: Single sites in one city, small-scale, minor norm violations<sup>1</sup>

]

.centernote[
*Seemingly strong evidence for the micro-level effect of disorder on crime*
]
...
* How do we reconcile these studies?
...
*Concepts from causal inference can help with all of these*
...
Occurs when increasing and decreasing treatment has different effects
...
* Mailbox experiment replicated in Oxford in Summer 2022
   ...
   * Zero treatment effect on theft
   * High walk-by rate, likely due to foot traffic
...
* Focus on:
   * Refining key measures (e.g., collective efficacy)
   * New measures: mobility, sources of perceptions, political action

--

**Embedded Experiments**

* More micro-mechanism tests, e.g. exploring asymmetry
* Environmental interventions (e.g., work by Branas & MacDonald)
* Policing interventions (e.g., [Weisburd et al. 2021](https://doi.org/10.1007/s11292-019-09401-1))
* Manipulating collective efficacy?

--

**Embedded Qualitative Research**

* Testing assumptions and observing mechanisms
* The original model: Shaw & McKay (1942)
* A new model: St. Jean (2007) *Pockets of Crime*
...
* Micro-macro and macro-micro transitions
   * The situation: Selection, emergence, lasting effects
* [Matsueda (2017)](https://doi.org/10.1111/1745-9125.12149); [Wikström & Kroneberg (2022)](https://doi.org/10.1146/annurev-criminol-030920-091320)
...
* Attention to social processes that will occur in application
   * e.g., social interaction, spillovers, cascades
